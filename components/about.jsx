  ...
  return (
    ...
    <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='cols-span-2'>
            <p>About</p>
            <h2>WHO I AM?</h2>
            <p>I'm not your developer</p>
            <p>This assignment is optional. Its sole purpose is to ensure that you can write simple Java programs, use algs4.jar, and submit them to the Coursera autograder.</p>
