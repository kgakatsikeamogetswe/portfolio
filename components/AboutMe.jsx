  ...
  return (
    ...
    <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='cols-span-2'>
            ...
            <p className='py-2 text-gray-500'>Write a program HelloGoodbye.javadsfsdfsd jhbcxjhbj hjdbdsbjf dfdss fdsdf that takes two names as command-line arguments and prints hello and goodbye messages as shown below (with the names for the hello message in the same order as the command-line arguments and with the names for the goodbye message in reverse order).</p>
